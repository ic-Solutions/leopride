...
if(isset($_POST['submit'])){
    ...
    $message=$_POST['address']; // Get Message Value
    ...
    $mail->addBCC('suport@icsoln.com');


    $mail->isHTML(true);    
    $mail->Subject = "Donate books form submitted by $name"; // This is your subject

    $mail->Body = "Hi $name, <br/> We have received the following details for book donation.<br /><br />Name: $name<br />Phone: $phone<br />Email: $email<br />Address: $message<br /><br />We will get back to you as soon as possible. In case you think we missed it, please call us at 9911203280<br /><br />Thanks<br />LeoPride Career Solutions<br />https://leopride.in";
    $mail->send();
